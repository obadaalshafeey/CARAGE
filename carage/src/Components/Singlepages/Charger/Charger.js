...
function Charger() {
    ...
    const clickHandel = ()=>{
        axios.post('http://localhost/carage/carage_backend/charger.php?name='+name+'&phone_number='+phone+'&car_type='+car_type+'&location='+location+'&charger_type='+order+'&auto_order_weekly='+auto_order)
        .then((data) => {
